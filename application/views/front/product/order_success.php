    ...
    <div class="card">
        <div class="card-body">
            <div class="text-center">
                ...
                <table class="table table-striped table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $last_transaksi->product_qty; ?> Hari</td>
                            <td>Rp. <?php echo number_format($last_transaksi->product_price, '0', ',', '.'); ?></td>
                            <td>Rp. <?php $total = $last_transaksi->product_price * $last_transaksi->product_qty;
                                    echo number_format($total, '0', ',', '.'); ?></td>
                        </tr>

                        <tr>
                            <th colspan="3"><span class="pull-right">Total</span></th>
                            <th>Rp. <?php $total = $last_transaksi->product_price * $last_transaksi->product_qty;
                                    echo number_format($total, '0', ',', '.'); ?></th>
                        </tr>
                        <tr>

                            <td colspan="4">Harga Belum Termasuk BBM, Toll, Parkir dan Uang Makan Driver, Silahkan menghubungi Admin untuk Info lebih Lanjut<br>
                ...
                Terima Kasih Telah Order di <?php echo $meta->title; ?>
            </div>
        </div>
    </div>
